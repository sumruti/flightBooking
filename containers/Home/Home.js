 ...
 return (
        ...
        <section className="flexslider-container" id="flexslider-container-1">
          <div className="flexslider slider" id="slider-1">
            <ul className="slides">
              <li className="item-1" style={{background: 'linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(../../images/images/homepage-slider-1.jpg) 50% 0%', backgroundSize: 'cover', height: '100%'}}>
                <div className=" meta">         
              ...
              <li className="item-2" style={{background: 'linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url(../../images/images/homepage-slider-1.jpg) 50% 0%', backgroundSize: 'cover', height: '100%'}}>
                <div className=" meta">         
                  <div className="container">
                    <h2>Discover</h2>
                    <h1>Australia</h1>
                ...
                <div className="owl-carousel owl-theme owl-custom-arrow" id="owl-hotel-offers">
                  <div className="item">
                    <div className="main-block hotel-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/hotel-1.jpg" className="img-responsive" alt="hotel-img" />
                        </a>
                  ...
                  <div className="item">
                    <div className="main-block hotel-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/hotel-2.jpg" className="img-responsive" alt="hotel-img" />
                        </a>
                        <div className="main-mask">
                          <ul className="list-unstyled list-inline offer-price-1">
                            <li className="price">$568.00<span className="divider">|</span><span className="pkg">Avg/Night</span></li>
                  ...
                  <div className="item">
                    <div className="main-block hotel-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/hotel-3.jpg" className="img-responsive" alt="hotel-img" />
                        </a>
                        <div className="main-mask">
                          <ul className="list-unstyled list-inline offer-price-1">
                            <li className="price">$568.00<span className="divider">|</span><span className="pkg">Avg/Night</span></li>
                  ...
                  <div className="item">
                    <div className="main-block hotel-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/hotel-4.jpg" className="img-responsive" alt="hotel-img" />
                        </a>
                        <div className="main-mask">
                          <ul className="list-unstyled list-inline offer-price-1">
                            <li className="price">$568.00<span className="divider">|</span><span className="pkg">Avg/Night</span></li>
                ...
                <div className="owl-carousel owl-theme owl-custom-arrow" id="owl-tour-offers">
                  <div className="item">
                    <div className="main-block tour-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/tour-1.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                      </div>{/* end offer-img */}
                  ...
                  <div className="item">
                    <div className="main-block tour-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/tour-2.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                      </div>{/* end offer-img */}
                      <div className="offer-price-2">
                        <ul className="list-unstyled">
                  ...
                  <div className="item">
                    <div className="main-block tour-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/tour-3.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                      </div>{/* end offer-img */}
                      <div className="offer-price-2">
                        <ul className="list-unstyled">
                  ...
                  <div className="item">
                    <div className="main-block tour-block">
                      <div className="main-img">
                        <a href="#">
                          <img src="../../images/images/tour-4.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                      </div>{/* end offer-img */}
                      <div className="offer-price-2">
                        <ul className="list-unstyled">
                      ...
                      <div className="row">
                        <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                          <div className="main-img cruise-img">
                            <a href="#">
                              <img src="../../images/images/cruise-1.jpg" className="img-responsive" alt="cruise-img" />
                    ...
                    <div className="main-block cruise-block">
                      <div className="row">
                        <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                          <div className="main-img cruise-img">
                            <a href="#">
                              <img src="../../images/images/cruise-2.jpg" className="img-responsive" alt="cruise-img" />
                              <div className="cruise-mask">
                                <p>7 Nights, 6 Days</p>
                              </div>{/* end cruise-mask */}
                            </a>
                    ...
                    <div className="main-block cruise-block">
                      <div className="row">
                        <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                          <div className="main-img cruise-img">
                            <a href="#">
                              <img src="../../images/images/cruise-3.jpg" className="img-responsive" alt="cruise-img" />
                              <div className="cruise-mask">
                                <p>7 Nights, 6 Days</p>
                              </div>{/* end cruise-mask */}
                            </a>
                    ...
                    <div className="main-block cruise-block">
                      <div className="row">
                        <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                          <div className="main-img cruise-img">
                            <a href="#">
                              <img src="../../images/images/cruise-4.jpg" className="img-responsive" alt="cruise-img" />
                              <div className="cruise-mask">
                                <p>7 Nights, 6 Days</p>
                              </div>{/* end cruise-mask */}
                            </a>
                ...
                <div className="row">
                    ...
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-1.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-2.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                        <div className="flight-info">
                          <div className="flight-title">
                            <h3><span className="flight-destination">Spain</span>|<span className="flight-type">OneWay Flight</span></h3>
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-3.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                        <div className="flight-info">
                          <div className="flight-title">
                            <h3><span className="flight-destination">Spain</span>|<span className="flight-type">OneWay Flight</span></h3>
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-4.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                        <div className="flight-info">
                          <div className="flight-title">
                            <h3><span className="flight-destination">Spain</span>|<span className="flight-type">OneWay Flight</span></h3>
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-5.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                        <div className="flight-info">
                          <div className="flight-title">
                            <h3><span className="flight-destination">Spain</span>|<span className="flight-type">OneWay Flight</span></h3>
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block flight-block">
                      <a href="#">
                        <div className="flight-img">
                          <img src="../../images/images/flight-6.jpg" className="img-responsive" alt="flight-img" />
                        </div>{/* end flight-img */}
                        <div className="flight-info">
                          <div className="flight-title">
                            <h3><span className="flight-destination">Spain</span>|<span className="flight-type">OneWay Flight</span></h3>
                ...
                <div className="row">
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block vehicle-block">
                      <div className="main-img vehicle-img">
                        <a href="#">
                          <img src="../../images/images/vehicle-1.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block vehicle-block">
                      <div className="main-img vehicle-img">
                        <a href="#">
                          <img src="../../images/images/vehicle-2.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                        <div className="vehicle-time">
                          <p><span><i className="fa fa-clock-o" /></span>22/h</p>
                        </div>{/* end vehicle-time */}
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block vehicle-block">
                      <div className="main-img vehicle-img">
                        <a href="#">
                          <img src="../../images/images/vehicle-3.jpg" className="img-responsive" alt="tour-img" />
                        </a>
                        <div className="vehicle-time">
                          <p><span><i className="fa fa-clock-o" /></span>22/h</p>
                        </div>{/* end vehicle-time */}
                ...
                <div className="row">
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block latest-block">
                      <div className="main-img latest-img">
                        <a href="#">
                          <img src="../../images/images/latest-blog-1.jpg" className="img-responsive" alt="blog-img" />
                        </a>
                      </div>{/* end latest-img */}
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block latest-block">
                      <div className="main-img latest-img">
                        <a href="#">
                          <img src="../../images/images/latest-blog-2.jpg" className="img-responsive" alt="blog-img" />
                        </a>
                      </div>{/* end latest-img */}
                      <div className="latest-info">
                        <ul className="list-unstyled">
                  ...
                  <div className="col-sm-6 col-md-4">
                    <div className="main-block latest-block">
                      <div className="main-img latest-img">
                        <a href="#">
                          <img src="../../images/images/latest-blog-3.jpg" className="img-responsive" alt="blog-img" />
                        </a>
                      </div>{/* end latest-img */}
                      <div className="latest-info">
                        <ul className="list-unstyled">
                ...
                <div className="row">
                  ...
                  <div className="col-xs-12 col-sm-6">
                    <div className="popup-ad-img">
                      <img src="../../images/images/about-content-2.png" className="img-responsive" /> 
