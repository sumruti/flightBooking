        ...
        <section className="flexslider-container" id="flexslider-container-5">
          <div className="header-absolute">
            <div className="container">
              <div id="top-bar" className="tb-text-grey">
                <div className="row">          
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <div id="links">
                      <ul className="list-unstyled list-inline">
                        <li><a href="#"><span><i className="fa fa-lock" /></span>Login</a></li>
                        <li><a href="#"><span><i className="fa fa-plus" /></span>Sign Up</a></li>
                        <li>
                          <form>
                  ...
                  <ul className="nav navbar-nav navbar-right navbar-search-link">
                    <li className="dropdown active"><a href="#" className="dropdown-toggle" data-toggle="dropdown">Home<span><i className="fa fa-angle-down" /></span></a>
                      <ul className="dropdown-menu">
                        ...
                        <li className="active"><a href="#">Cruise Homepage</a></li>
              ...
              <div id="main-menu">
                ...
                <div className="list-group panel">
                  ...
                  <div className="collapse sub-menu" id="home-links">
                    ...
                    <a href="#" className="list-group-item active">Cruise Homepage</a>
          ...
          <div className="flexslider slider" id="slider-5">
            <ul className="slides">
              <li className="item-1 back-size" style={{background: 'linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(images/cruise-slider-1.jpg) 50% 65%', backgroundSize: '142%', height: '100%'}}>
                <div className="meta">         
                  <div className="container">
              ...
              <li className="item-2 back-size" style={{background: 'linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)),url(images/cruise-slider-1.jpg) 50% 65%', backgroundSize: '142%', height: '100%'}}>
                <div className=" meta">         
                  <div className="container">
                    <h2>Dubai Boat Tour</h2>
                    <p>Lorem ipsum dolor sit amet, ad duo fugit aeque fabulas, in lucilius prodesset pri. Veniam delectus ei vis. Est atqui timeam mnesarchum at, pro an eros perpetua ullamcorper.</p>
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-12">
                ...
                <div className="owl-carousel owl-theme owl-custom-arrow" id="owl-cruise-offers">
                  <div>
                    <div className="grid">
                      ...
                      <div className="main-block cruise-block">
                        <div className="row">
                          <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                            <div className="main-img cruise-img">
                              <a href="cruise-detail-right-sidebar.html">
                                <img src="images/cruise-5.jpg" className="img-responsive" alt="cruise-img" />
                                <div className="cruise-mask">
                                  <p>7 Nights, 6 Days</p>
                                </div>{/* end cruise-mask */}
                              </a>
                      ...
                      <div className="main-block cruise-block">
                        <div className="row">
                          <div className="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                            <div className="main-img cruise-img">
                              <a href="cruise-detail-right-sidebar.html">
                                <img src="images/cruise-6.jpg" className="img-responsive" alt="cruise-img" />
                                <div className="cruise-mask">
                                  <p>7 Nights, 6 Days</p>
                                </div>{/* end cruise-mask */}
                              </a>
                ...
                <div className="view-all text-center">
                  <a href="cruise-listing-right-sidebar.html" className="btn btn-orange">View All</a>
                </div>{/* end view-all */}
              </div>{/* end columns */}
            </div>{/* end row */}
          </div>{/* end container */}
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-6 cruise-offer-img text-center">
                <img src="images/best-offer-cruise.jpg" className="img-responsive" alt="offer-img" />
              </div>{/* end columns */}
                ...
                <div className="carousel slide" data-ride="carousel" id="quote-carousel">
                  <div className="carousel-inner text-center">
                    <div className="item active">
                      ...
                      <p className="position">Director, Smal Bizz</p>
                    </div>{/* end item */}
                    <div className="item">
                      <div className="rating">
                        <span><i className="fa fa-star orange" /></span>
                  ...
                  <ol className="carousel-indicators">
                    <li data-target="#quote-carousel" data-slide-to={0} className="active"><img src="images/client-1.jpg" className="img-responsive" alt="client-img" />
                    </li>
                    <li data-target="#quote-carousel" data-slide-to={1}><img src="images/client-2.jpg" className="img-responsive" alt="client-img" />
                    </li>
                    <li data-target="#quote-carousel" data-slide-to={2}><img src="images/client-3.jpg" className="img-responsive" alt="client-img" />
                    </li>
                  </ol>
